...
{   
    ...
    for(int j=0;j<n;j++)
    {
        if(a[i].first>a[j].first and a[i].second==a[j].second)l=true;
        if(a[i].first<a[j].first and a[i].second==a[j].second)r=true;
        if(a[i].second>a[j].second and a[i].first==a[j].first)u=true;
        if(a[i].second<a[j].second and a[i].first==a[j].first)d=true;
    }
